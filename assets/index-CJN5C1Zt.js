...
reactIs_production_min.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === e || a === m$1 || a === g$1 || a === f$1 || a === p || a === q$1 || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r || a.$$typeof === h || a.$$typeof === k$1 || a.$$typeof === n || a.$$typeof === w$1 || a.$$typeof === x$1 || a.$$typeof === y$1 || a.$$typeof === v$1);
};
...
`;
const EmptyCartContainer = newStyled.div`
  text-size: 16px;
  flex: 1;
  display: flex;
...
`;
const CardInfoSection = newStyled.div`
  display: flex;
  align-items: center;
  gap: 24px;
`;
...
const ProductInfoSection = newStyled.div`
  ...
  justify-content: space-between;
`;
const ProductDescription = newStyled.div`
  display: flex;
  flex-direction: column;
  gap: 5px;
`;
...
const Button = ({ iconUrl, title, onClick, css: css2, disabled, testId }) => {
...
const CartCount = ({ count, onPlusCount, onMinusCount }) => {
  const className = css`
    border-radius: 10px;
    padding: 5px 5px;
  `;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CartCountSection, { children: [
    ...
    count,
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: onPlusCount, iconUrl: "./plus-icon.svg", css: className })
  ] });
};
const CartCountSection = newStyled.div`
  ...
  align-items: center;
`;
const Container$4 = newStyled.label`
  display: flex;
  gap: 8px;
  align-items: center;
`;
const HiddenCheckBox = newStyled.input`
  display: none;
`;
const CheckBox$1 = newStyled.img`
  cursor: pointer;
`;
const Label$1 = newStyled.label`
  cursor: pointer;
`;
const CheckBox = ({ isChecked, onChange, label, testId }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$4, { children: [
    ...
    label && /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: "checkbox", children: label })
  ] });
};
const Line = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LineContainer, {});
};
const LineContainer = newStyled.div`
  border: 1px solid #0000001a;
`;
const apiClient = {
  ...
  update: ({ endPoint, headers, body }) => requestApi("PATCH", endPoint, headers, body)
};
const requestApi = async (method, endPoint, headers, body) => {
  const token2 = "bWluamkyMjE5OnBhc3N3b3Jk";
  const response = await fetch(`${"http://techcourse-lv2-alb-974870821.ap-northeast-2.elb.amazonaws.com"}${endPoint}`, {
    method,
    headers: {
...
const deleteCartProduct = (cartId) => apiClient.delete({ endPoint: `/cart-items/${cartId}` });
...
const updateCartProduct = (cartId, quantity) => apiClient.update({
...
const Card = ({
  ...
  const handleDelete = async (id2) => {
    try {
      await deleteCartProduct(id2);
      onDeleteSelected();
      onRefetch();
    } catch (e2) {
      showError == null ? void 0 : showError("데이터를 삭제하는 중 문제가 발생했습니다.");
    }
  };
  const handleUpdate = async (id2, updatedQuantity) => {
    try {
      await updateCartProduct(id2, updatedQuantity);
      onRefetch();
    } catch (e2) {
      showError == null ? void 0 : showError("상품을 추가/삭제하는 중 문제가 발생했습니다.");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ButtonSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CheckBox, { isChecked, onChange: onToggle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => handleDelete(cartItem.id), title: "삭제" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardInfoSection, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ImgSection,
        {
          src: imageUrl,
          alt: name,
          onError: (e2) => e2.currentTarget.src = "./null-image.png"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ProductInfoSection, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(ProductDescription, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProductPrice, { children: formatPrice(price) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          CartCount,
          {
            ...
            onMinusCount: () => handleUpdate(cartItem.id, cartItem.quantity - 1)
          }
        )
      ] })
    ] }),
...
`;
const Header = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Container$3, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Title$1, { children: "장바구니" }) });
};
...
const Container$2 = pt.div``;
const Description$1 = pt.div`
  font-size: 12px;
  padding-bottom: 10px;
`;
const PriceInfo = pt.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  font-weight: 700;
...
`;
const Label = pt.span``;
const Price$1 = pt.span`
  font-size: 24px;
`;
const PriceSection$1 = ({ orderPrice, deliveryPrice, totalPrice }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$2, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description$1, { children: "※ 총 주문 금액이 100,000원 이상일 경우 무료 배송됩니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Line, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceInfo, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "주문 금액" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Price$1, { children: formatPrice(orderPrice) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceInfo, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "배송비" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Price$1, { children: formatPrice(deliveryPrice) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Line, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceInfo, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "총 결제 금액" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Price$1, { children: formatPrice(totalPrice) })
    ] })
  ] });
};
...
const useGetCartItem = () => {
  ...
  const getProducts = async () => {
    try {
      ...
      showError == null ? void 0 : showError("데이터를 불러오는 중 문제가 발생했습니다.");
    }
  };
  reactExports.useEffect(() => {
    getProducts();
...
const useSelectedCart = (cartItems) => {
  const [selectedCartId, setSelectedCartId] = reactExports.useState([]);
  const isSetting = reactExports.useRef(false);
  const handleAllSelected = () => {
    const isAllChecked = (selectedCartId == null ? void 0 : selectedCartId.length) === (cartItems == null ? void 0 : cartItems.length);
    if (isAllChecked) {
      setSelectedCartId([]);
      return;
    }
    setSelectedCartId((cartItems == null ? void 0 : cartItems.map((item) => item.id)) || []);
  };
  const handleToggle = (id2) => {
    if (!(selectedCartId == null ? void 0 : selectedCartId.find((item) => item === id2))) {
      setSelectedCartId((prev2) => [...prev2, id2]);
      return;
    }
    setSelectedCartId(selectedCartId == null ? void 0 : selectedCartId.filter((cartId) => cartId !== id2));
  };
  ...
  reactExports.useEffect(() => {
    if (cartItems && !isSetting.current) {
      const cartIdList = cartItems == null ? void 0 : cartItems.map((item) => item.id);
...
const CartSection = () => {
  ...
  const { selectedCartId, handleAllSelected, handleToggle, handleDelete } = useSelectedCart(cartItems);
  const isChecked = (id2) => {
    return selectedCartId == null ? void 0 : selectedCartId.some((item) => item === id2);
  };
  const isAllChecked = (selectedCartId == null ? void 0 : selectedCartId.length) === (cartItems == null ? void 0 : cartItems.length);
  const selectedItem = cartItems == null ? void 0 : cartItems.filter(
    (item) => selectedCartId.indexOf(item.id) > -1
  );
  const getOrderPrice = () => {
    return (selectedItem == null ? void 0 : selectedItem.reduce(
      (total, current) => current.product.price * current.quantity + total,
      0
    )) ?? 0;
  };
  const totalAmount = selectedItem == null ? void 0 : selectedItem.reduce(
    (total, current) => total + current.quantity,
    0
  );
  const orderPrice = getOrderPrice();
  const deliveryPrice = orderPrice >= 1e5 ? 0 : 3e3;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$5, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Wrapper, { children: [
      ...
      (cartItems == null ? void 0 : cartItems.length) === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyCartContainer, { "data-testid": "empty-page", children: "장바구니에 담은 상품이 없습니다." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Description$2, { children: [
          "현재 ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartList, { "data-testid": "cart-list", children: cartItems == null ? void 0 : cartItems.map((cartItem) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            cartItem,
            onRefetch: refetch,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartSection, {}) });
}
...
const NavBar = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container$1, { children: pathname === "/" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { children: "SHOP" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      BackIcon,
      {
        src: "./back-icon.svg",
...
const Description = newStyled.p`
  ...
  line-height: 150%;
`;
const PriceSection = newStyled.div`
  display: flex;
  flex-direction: column;
  font-weight: 700;
  gap: 12px;
...
const Confirm = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { "data-testid": "order-confirm-description", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(PriceSection, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PriceSection, { children: "총 결제 금액" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Price, { children: formatPrice(totalPrice) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
...
const router = createBrowserRouter([
  {
    element: /* @__PURE__ */ jsxRuntimeExports.jsx(NavBar, {}),
    children: [
      {
        path: PATH.MAIN,
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Router, {}) }) })
);
